...
try
{
	...
	String status=null;
	   ...
	   if(bal>balance)
	   {
		...
		out.println("<tr>");
		out.println("<td>Before withdraw,account balance is : "+"<td>"+bal);
		out.println("<tr>");
		out.println("<td>Withdraw Amount is : "+"<td>"+balance);
		out.println("<tr>");
		out.println("<td>After Withdraw,account balance is : "+"<td>"+Amount);
		out.println("</table>");
	}
	   else
		{
